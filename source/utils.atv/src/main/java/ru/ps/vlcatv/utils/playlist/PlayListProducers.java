...
public class PlayListProducers extends ReflectAttribute implements PlayListParentTableInterface {

    public PlayListProducers() {}
    public PlayListProducers(String s, long d) {
        id = d;
        Name = s;
    }
    ...
    public <T> T getNewClassIndex() {
        ...
        return (T) new PlayListProducersIndex(id);
    }
    @Override
    ...
    public <T> T getNewClassInstance(String s, long d) {
        //noinspection unchecked
        return (T) new PlayListProducers(s, d);
    }
}
