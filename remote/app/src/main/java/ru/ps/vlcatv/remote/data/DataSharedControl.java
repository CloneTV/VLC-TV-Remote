...
public class DataSharedControl extends BaseObservable {
    ...
    public static final int BTN_MENU = R.id.imgbtn_menu;
    ...
    public static final int BTN_TITLE = R.id.tv_title;
    ...
    public DataSharedControl() {
        ...
        MmItems = new DataMediaItem[] { new DataMediaItem(), null, null, null, null };
        ...
        //Title.addOnPropertyChangedCallback(cb);
        //FileName.addOnPropertyChangedCallback(cb);
    ...
    public void clickStateChange(int id) {
        switch (id) {
            case BTN_HOME: {
                AppRun.set(!AppRun.get());
                break;
            }
            default: {
                break;
