...
public class PlayListCountry extends ReflectAttribute implements PlayListParentTableInterface {

    public PlayListCountry() {}
    public PlayListCountry(String s, long d) {
        id = d;
        Name = s;
    }
    ...
    @Override
    public boolean equalsName(PlayListParentTableInterface pti) {
        if ((Name == null) || (pti == null) || (pti.getName() == null))
            return false;
        return Name.equals(pti.getName());
    }
    @Override
    ...
    public <T> T getNewClassIndex() {
        ...
        return (T) new PlayListCountryIndex(id);
    }
    @Override
    ...
    public <T> T getNewClassInstance(String s, long d) {
        //noinspection unchecked
        return (T) new PlayListCountry(s, d);
    }
}
