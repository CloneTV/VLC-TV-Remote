...
public class PlayListTags extends ReflectAttribute implements PlayListParentTableInterface {

    public PlayListTags() {}
    public PlayListTags(String s, long d) {
        id = d;
        Name = s;
    }
    ...
    public <T> T getNewClassIndex() {
        ...
        return (T) new PlayListTagsIndex(id);
    }
    @Override
