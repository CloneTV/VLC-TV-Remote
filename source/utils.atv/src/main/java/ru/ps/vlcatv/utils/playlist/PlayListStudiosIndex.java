...
@Keep
@IBaseTableReflect(
        IThisTableName = "TableStudiosIndex",
...
public class PlayListStudiosIndex extends ReflectAttribute {

    public PlayListStudiosIndex() {}
    public PlayListStudiosIndex(long l) {
        indexStudio = l;
    }
    @IFieldReflect("idx_id")
    public long indexStudio = -1;
}
